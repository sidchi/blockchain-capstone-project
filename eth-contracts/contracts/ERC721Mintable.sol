...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender == getOwner() || isApprovedForAll(owner,msg.sender) );
...
contract LandTitle is ERC721Metadata("LandTitle", "LT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
